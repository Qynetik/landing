						...
						<div className='fade-in'>
							<div className='flex flex-col gap-6'>
								...
								<p className='max-w-xl text-sm leading-relaxed text-slate-300 sm:text-base'>
									Qynetik automates complex AEM → headless migrations with
									schema mapping, validation, and delta replays. Less custom
									scripts, fewer broken links, and migration runs you can
									actually trust.
								</p>
								...
								<div className='mt-4 rounded-2xl border border-white/10 bg-slate-950/60 p-4 shadow-sm shadow-black/40 sm:p-5'>
									...
									<p className='mt-1 text-sm text-slate-200'>
										Building or planning an AEM migration in 2026? Join the
										early access list and we&apos;ll reach out with a demo.
									</p>
